...
<div class="container">
    ...
    <form action="${urlEditar}" modelAttribute="empleadoForma" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombreEmpleado" name="nombreEmpleado" value="${empleado.nombreEmpleado}" required="true">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="sueldo" name="sueldo" value="${empleado.sueldo}" step="any">
        </div>
